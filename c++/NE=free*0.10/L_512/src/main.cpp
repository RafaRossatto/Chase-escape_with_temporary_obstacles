...
for (int run = start_run; run <= end_run; run++) {
    ...
    oss_escaper << "/media/camafeu/data/rossatto/Chase-escape_with_temporary_obstacles_data/data/data_environment/512/simulation_frac_" 
                << frac << "_run_" << run << "/escapers.csv";
    std::string escaper_file = oss_escaper.str();
    
    std::ostringstream oss_chaser;
    oss_chaser << "/media/camafeu/data/rossatto/Chase-escape_with_temporary_obstacles_data/data/data_environment/512/simulation_frac_" 
    ...
    std::string path_out = "/media/camafeu/data/rossatto/Chase-escape_with_temporary_obstacles_data/data/data_raw/512/sre_2_src_2_prob_v_frac_v";
