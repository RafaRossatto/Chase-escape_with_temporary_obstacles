...
int main() {
    ...
    std::vector<Cell> escapers = Cell::loadFromCSV(escaper_file, "O");
    std::vector<Cell> chasers = Cell::loadFromCSV(chaser_file, "H");
    ...
    checkDuplicates(chasers, escapers, WIDTH, HEIGHT);
